...
*/
{
	...
	public class DistinctShape extends Meter
	{
		...
		// Constructor
		public function DistinctShape()
		{
			super();
			super.cell_mask = this.meter_mask_default;
			super.mask_outline = this.outline = this.alt_outline_1;
			this.alt_meter_mask_0.visible = this.alt_meter_mask_1.visible = this.alt_meter_mask_2.visible = this.alt_meter_mask_3.visible = this.alt_meter_mask_4.visible = false;
			this.alt_outline_0.visible = this.alt_outline_1.visible = this.alt_outline_2.visible = this.alt_outline_3.visible = this.alt_outline_4.visible = false;
		...
		*/		
		public override function reset()
		{
			...
			this.meter_mask = this.meter_mask;
		}
		...
		*/
 		public override function assignValues(inArr:Array):void {
			super.assignValues(inArr);
			if (inArr == null)
			{
				this.outline = this[OUTLINE + this.rank];
				this.meter_mask = this[METER_MASK + this.rank];
